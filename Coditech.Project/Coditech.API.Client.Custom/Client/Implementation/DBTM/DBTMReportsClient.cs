    ...
    public class DBTMReportsClient : BaseClient, IDBTMReportsClient
    {
        ...
        public virtual async Task<List<string>> GetActivityPerformedDatesAsync(string dBTMTestMasterIds, long dBTMTraineeDetailId, string centreCode, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (status_ == 200)
                {
                    var objectResponse = await ReadObjectResponseAsync<List<string>>(response, headers_, cancellationToken).ConfigureAwait(false);
                    return objectResponse.Object ?? new List<string>();
                }
                else if (status_ == 204)
                {
        ...
        public virtual List<string> GetBatchActivityPerformedDates(string dBTMTestMasterIds, int generalBatchMasterId)
        {
            return Task.Run(async () => await GetBatchActivityPerformedDatesAsync(dBTMTestMasterIds, generalBatchMasterId, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<List<string>> GetBatchActivityPerformedDatesAsync(string dBTMTestMasterIds, int generalBatchMasterId, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.GetBatchActivityPerformedDatesAsync(dBTMTestMasterIds, generalBatchMasterId);
        ...
        public virtual List<string> GetTraineeListActivityDates(string dBTMTraineeDetailIds, int generalBatchMasterId)
        {
            return Task.Run(async () => await GetTraineeListActivityDatesAsync(dBTMTraineeDetailIds, generalBatchMasterId, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<List<string>> GetTraineeListActivityDatesAsync(string dBTMTraineeDetailIds, int generalBatchMasterId, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.GetTraineeListActivityDatesAsync(dBTMTraineeDetailIds, generalBatchMasterId);
        ...
        public virtual DBTMTraineeProfileListResponse GetBatchWiseTraineeProfileDetailsList(long generalBatchMasterId, string dbtmTraineeDetailIds, string orderBy, DateTime FromDate, DateTime ToDate)
        {
            return Task.Run(async () => await GetBatchWiseTraineeProfileDetailsAsync(generalBatchMasterId, dbtmTraineeDetailIds, orderBy, FromDate, ToDate, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<DBTMTraineeProfileListResponse> GetBatchWiseTraineeProfileDetailsAsync(long generalBatchMasterId, string dbtmTraineeDetailIds, string orderBy, DateTime FromDate, DateTime ToDate, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.GetBatchWiseTraineeProfileDetailsAsync(generalBatchMasterId, dbtmTraineeDetailIds, orderBy, FromDate, ToDate);
            ...
            try
            {
                ...
                if (status_ == 200)
                {
                    var objectResponse = await ReadObjectResponseAsync<DBTMTraineeProfileListResponse>(response, headers_, cancellationToken).ConfigureAwait(false);
                    return objectResponse.Object ?? new DBTMTraineeProfileListResponse();
                }
                else if (status_ == 204)
                {
                    return new DBTMTraineeProfileListResponse();
                }
                else
                {
                    string responseData = response.Content == null
        ...
        public virtual async Task<DBTMTestWiseReportsListResponse> CampWiseMultipleReportsAsync(string dBTMTestMasterIds, int dBTMCampMasterId, DateTime fromDate, DateTime toDate, long entityId, string userType, string centreCode, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.CampWiseMultipleReportsAsync(dBTMTestMasterIds, dBTMCampMasterId, fromDate, toDate, entityId, userType, centreCode);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
                ...
                else
                {
                    ...
                    var typedBody = JsonConvert.DeserializeObject<DBTMTestWiseReportsListResponse>(responseData);
                    UpdateApiStatus(typedBody, status, response);
                    throw new CoditechException(status.ErrorCode, status.ErrorMessage, status.StatusCode);
                }
            }
        ...
        public virtual DBTMTestWiseReportsListResponse CampWiseMultipleReportsFile(string dBTMTestMasterIds,int dBTMCampMasterId, DateTime fromDate, DateTime toDate, long entityId, string userType, string centreCode, string reportType)
        {
            return Task.Run(async () => await CampWiseMultipleReportsFileAsync( dBTMTestMasterIds, dBTMCampMasterId, fromDate, toDate, entityId, userType, centreCode, reportType, CancellationToken.None)).GetAwaiter().GetResult();
        }
        public virtual async Task<DBTMTestWiseReportsListResponse> CampWiseMultipleReportsFileAsync(string dBTMTestMasterIds, int dBTMCampMasterId, DateTime fromDate, DateTime toDate, long entityId, string userType, string centreCode, string reportType, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.CampWiseMultipleReportsFileAsync(dBTMTestMasterIds, dBTMCampMasterId, fromDate, toDate, entityId, userType, centreCode, reportType);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
        ...
        public virtual List<string> GetCampActivityPerformedDates(string dBTMTestMasterIds, int dBTMCampMasterId)
        {
            return Task.Run(async () => await GetCampActivityPerformedDatesAsync(dBTMTestMasterIds, dBTMCampMasterId, CancellationToken.None)).GetAwaiter().GetResult();
        }
        public virtual async Task<List<string>> GetCampActivityPerformedDatesAsync(string dBTMTestMasterIds, int dBTMCampMasterId, CancellationToken cancellationToken)
        {
            string endpoint = dBTMReportsEndpoint.GetCampActivityPerformedDatesAsync(dBTMTestMasterIds, dBTMCampMasterId);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
