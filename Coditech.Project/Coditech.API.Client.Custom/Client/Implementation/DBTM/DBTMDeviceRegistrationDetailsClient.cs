...
namespace Coditech.API.Client
{
    public class DBTMDeviceRegistrationDetailsClient : BaseClient, IDBTMDeviceRegistrationDetailsClient
    {
        ...
        public virtual DBTMDeviceRegistrationDetailsListResponse GetDeviceSerialCodeByCentreCode(string centreCode)
        {
            return Task.Run(async () => await GetDeviceSerialCodeByCentreCode(centreCode, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<DBTMDeviceRegistrationDetailsListResponse> GetDeviceSerialCodeByCentreCode(string centreCode, CancellationToken cancellationToken)
        {
            string endpoint = dBTMDeviceRegistrationDetailsEndpoint.GetDeviceSerialCodeByCentreCode(centreCode);
            HttpResponseMessage response = null;
            var disposeResponse = true;
