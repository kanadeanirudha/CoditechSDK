...
namespace Coditech.API.Client
{
    public class DBTMNewRegistrationClient : BaseClient, IDBTMNewRegistrationClient
    {
        ...
        public virtual DBTMNewRegistrationResponse IndividualRegistration(DBTMNewRegistrationModel body)
        {
            return Task.Run(async () => await IndividualRegistrationAsync(body, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<DBTMNewRegistrationResponse> IndividualRegistrationAsync(DBTMNewRegistrationModel body, CancellationToken cancellationToken)
        {
            string endpoint = dBTMNewRegistrationEndpoint.IndividualRegistrationAsync();
            HttpResponseMessage response = null;
            bool disposeResponse = true;
            try
            {
