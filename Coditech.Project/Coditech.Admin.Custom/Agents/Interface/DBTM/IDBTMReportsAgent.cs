...
namespace Coditech.Admin.Agents
{
    public interface IDBTMReportsAgent
    {
        ...
        DBTMReportVerticalDataViewModel GetActivityVerticalDetails(long dBTMDeviceDataId, string typeOfRecord);
        ...
        DBTMReportTraineeProfileListModel GetBatchWiseTraineeProfileDetailsListV2(long generalBatchMasterId, string dbtmTraineeDetailIds, string orderBy, DateTime FromDate, DateTime ToDate, string typeOfRecord);
    }
}
