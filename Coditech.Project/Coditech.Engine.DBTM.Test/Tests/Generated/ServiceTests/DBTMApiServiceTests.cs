...
{
    public class DBTMApiServiceTests
    {
        [Fact]
        public void Constructor_Should_Create_Instance_Without_Running_Constructor()
        {
            ...
            Assert.NotNull(asm);
            var type = asm.GetType("Coditech.API.Service.DBTMApiService");
            Assert.NotNull(type);
            var instance = FormatterServices.GetUninitializedObject(type);
            Assert.NotNull(instance);
        }

        [Fact(Skip = "TODO: implement unit tests for public methods in DBTMApiService")]
        public void TODO() { }
    }
}
