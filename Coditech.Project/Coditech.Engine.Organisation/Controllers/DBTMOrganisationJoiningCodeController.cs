...
namespace Coditech.API.Controllers
{
    ...
    public class DBTMOrganisationCentrewiseJoiningCodeController : BaseController
    {
        ...
        public virtual IActionResult GetTraineeActiveJoiningCode(string centreCode)
        {
            try
            {
                DBTMOrganisationCentrewiseJoiningCodeModel list = _dBTMOrganisationCentrewiseJoiningCodeService.GetTraineeActiveJoiningCode(centreCode);
